...
class AdminLandlordScreen extends StatefulWidget {
  const AdminLandlordScreen({super.key});

  @override
  _AdminLandlordScreenState createState() => _AdminLandlordScreenState();
}

class _AdminLandlordScreenState extends State<AdminLandlordScreen> {
  int _selectedIndex = 0;
  final LandlordService _landlordService = LandlordService(base_url); // Replace with your API base URL
  ...
  Future<void> _deleteLandlord(int id) async {
    try {
      ...
      setState(() {
        _landlords.removeWhere((landlord) => landlord.id == id);
      });
    } catch (e) {
      // Handle error
    }
  ...
  void _showLandlordDetailsDialog(Landlord landlord) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text('Phone: ${landlord.phoneNumber}'),
                SizedBox(height: 10),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Manage Landlords', style: TextStyle(color: Colors.black)),
        actions: [
          TextButton(
            onPressed: () {},
