...
class LandlordEmergencyScreen extends StatefulWidget {
  const LandlordEmergencyScreen({super.key});

  @override
  _LandlordEmergencyScreenState createState() => _LandlordEmergencyScreenState();
}

class _LandlordEmergencyScreenState extends State<LandlordEmergencyScreen> {
  @override
