...
class LandlordTenantScreen extends StatefulWidget {
  const LandlordTenantScreen({super.key});

  @override
  _LandlordTenantScreenState createState() => _LandlordTenantScreenState();
}
...
class _LandlordTenantScreenState extends State<LandlordTenantScreen> {
  ...
  Future<void> _fetchTenants() async {
    try {
      final tenants = await _tenantService.fetchLandlordTenants();
      setState(() {
        _tenants = tenants;
        _isLoading = false;
      });
